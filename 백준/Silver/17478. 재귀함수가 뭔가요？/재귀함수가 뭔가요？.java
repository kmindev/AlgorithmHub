...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        questionAmount = Integer.parseInt(br.readLine());
        chatBot(questionAmount);
    }

    private static void chatBot(int i) {
        String underLine = printLine(i);
        if (i == questionAmount)
    ...
    private static String printLine(int i) {
        StringBuilder sb = new StringBuilder();
        for (int j = questionAmount - i; j > 0; j--)
            sb.append("____");
        return sb.toString();
    }
}